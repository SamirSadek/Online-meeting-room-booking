...
async function Rooms() {
  ...
  return (
    <div className="bg-orange-50 py-10">
      ...
      <h1 className="sm:text-3xl text-xl font-bold title-font mb-4 text-gray-900">Available Rooms</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Book a Meeting for Your Meeting</p>
    </div>
      ...
      >
        ...
        <div className="flex items-center justify-between text-gray-600 mt-3 text-sm">
          ...
          <div className="flex gap-2 items-center">
            ...
            <p className="font-medium">Updated: {room.updatedAt.toLocaleString()}</p>
          </div>
        </div>
